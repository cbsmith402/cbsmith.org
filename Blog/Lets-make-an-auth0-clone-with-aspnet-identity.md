...
![Startup.Auth cookie handler code](Sheetrock_VS2013_StartupAuth.png)
...
![Fiddler with successful response from Azure Mobile Services](Sheetrock_Fiddler_AMS_Response.png)
